...
public class MailServerConstants
{
	...
	public static final String					LOCAL_DOMAIN_NAME		= "10.113.59.124";

	public static final String					DATA_TERMINATOR			= " . ";

	public static final String					KEYWORD_CONF_FILE		= "config/KeywordMap.conf";

	public static final String					POP_CONF_FILE			= "config/PopKeywordMap.conf";

	public static final String					PROPERTIES_FILE			= "config/Properties.conf";
